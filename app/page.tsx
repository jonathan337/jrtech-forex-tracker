    ...
    <div className="min-h-screen min-w-0 overflow-x-clip">
      ...
      <section className="py-14 sm:py-20 px-4">
        <div className="max-w-6xl mx-auto text-center min-w-0">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-700 mb-8">
            <span className="text-white font-bold text-3xl">FX</span>
          </div>
          <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold tracking-[-0.03em] mb-6 text-blue-700 px-1">
