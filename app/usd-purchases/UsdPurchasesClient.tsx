...
type UsdPurchasesInitialData = {
  purchases: PurchaseRow[]
  summary: MonthUsdCostSummary | null
}

export function UsdPurchasesClient({
  initialData,
  initialYear,
  initialMonth,
}: {
  initialData: UsdPurchasesInitialData | null
  initialYear: number
  initialMonth: number
}) {
  ...
  // Only the very first load shows the spinner; later refreshes update in place.
  ...
  const [summary, setSummary] = useState<MonthUsdCostSummary | null>(
