    ...
    <div className="space-y-6 min-w-0">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="shadow-md hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            <div className="text-2xl font-bold tabular-nums text-blue-600">${data.summary.totalFees.toFixed(2)}</div>
      ...
      {/* Info Card */}
      <Card className="bg-gradient-to-br from-blue-50 to-blue-50 border-2 border-blue-200">
        <CardHeader>
