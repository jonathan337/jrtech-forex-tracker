...
export function UsageClient({
  ...
  initialData: UsageInitialData | null
  initialYear: number
  initialMonth: number
}) {
  ...
  const [cards, setCards] = useState<CardOption[]>(initialData?.cards ?? [])
  ...
  useEffect(() => {
    ...
    // First authenticated render already has SSR data for this month.
