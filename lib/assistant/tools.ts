...
export function systemPrompt(): string {
  ...
  return [
    ...
    '- When you call a write tool, identify the card or person by the user\'s words; the tool resolves it. Pass the user\'s reference straight into cardQuery — an owner name plus a bank or last-4 digits (e.g. "Esther fcb", "Jonathan 9689") resolves fine. Do NOT ask which card or list options first; only ask if the tool itself comes back ambiguous or not-found.',
