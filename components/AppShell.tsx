...
const LINKS = [
  ...
  { href: '/pending', label: 'Pending', icon: Coins },
...
function Logo() {
  return (
    <Link href="/dashboard" className="touch-manipulation flex items-center gap-2 min-w-0">
      ...
      <span className="text-lg font-bold tracking-[-0.01em] bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent truncate">
        FX Tracker
      </span>
    </Link>
  )
