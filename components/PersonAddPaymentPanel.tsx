...
export function PersonAddPaymentPanel({
  ...
  return (
    <div className="mb-4 rounded-lg border border-indigo-100 bg-indigo-50/50 p-4 space-y-3">
      <div className="flex items-start gap-2">
        <Banknote className="w-5 h-5 text-indigo-700 shrink-0 mt-0.5" aria-hidden />
